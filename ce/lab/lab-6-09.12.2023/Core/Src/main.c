...
int main(void)
{
  ...
  while (1)
  {
	  CS43L22_Beep(F5, quarterNote);
	  HAL_Delay(100);
	  CS43L22_Beep(E5, eighthNote);
	  HAL_Delay(100);
	  CS43L22_Beep(F5, quarterNote);
	  HAL_Delay(100);
	  CS43L22_Beep(G5, eighthNote);
	  HAL_Delay(100);
	  CS43L22_Beep(F5, quarterNote);
	  HAL_Delay(100);
	  CS43L22_Beep(E5, eighthNote);
	  HAL_Delay(100);
	  CS43L22_Beep(D5, eighthNote);
	  HAL_Delay(100);
	  CS43L22_Beep(C5, quarterNote);
	  HAL_Delay(100);
	  CS43L22_Beep(D5, quarterNote);
	  HAL_Delay(100);
	  CS43L22_Beep(C5, eighthNote);
	  HAL_Delay(100);
	  CS43L22_Beep(D5, eighthNote);
	  HAL_Delay(100);
	  CS43L22_Beep(E5, quarterNote);
	  HAL_Delay(100);
	  CS43L22_Beep(F5, dottedQuaterNote);
	  HAL_Delay(1000);
