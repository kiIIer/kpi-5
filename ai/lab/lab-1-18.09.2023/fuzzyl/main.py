...
plt.title('Ймовірності подій A і B')
plt.grid(True)
plt.legend()
...
plt.title('Кон\'юнктивний оператор (AND) у вірогідній інтерпретації')
plt.grid(True)
plt.legend()
...
plt.xlabel('Вірогідність')
plt.ylabel('Ймовірність')
plt.title('Диз\'юнктивний оператор (OR) у вірогідній інтерпретації')
plt.grid(True)
plt.legend()
